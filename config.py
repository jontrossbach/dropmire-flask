...
class Config(object):
    ...
    SQLALCHEMY_DATABASE_URI = "postgresql+psycopg2://" + str(os.environ.get('DROPMIRE_DB_USER')) + ":" + str(os.environ.get('DROPMIRE_DB_USER')) + "@" + str(os.environ.get('POSTGRESQL_SERVICE_HOST')) + ":5432/" + str(os.environ.get('DROPMIRE_DB_NAME'))
